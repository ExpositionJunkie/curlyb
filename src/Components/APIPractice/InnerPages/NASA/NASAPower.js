  ...
  return (
    <div className="nasa_wrapper">
      ...
      <h3>
        ...
        <a href="https://power.larc.nasa.gov/api/pages/" target="_blank" rel="noreferrer">
          NASA Power API
        </a>
      ...
      <p>
        Being in Seattle, it doesn't normally have very good readings, so if you
        see a lot of -999 that means it didn't get enough sun to record data.
        Will be changing this later, but for now, enjoy the local lore.
      </p>
